...
from NJ_treeSerial import NJTree;
from DistanceMatrixCalculatorSerial import DistanceCalculator
import time
...
class Tree_Generation:
    ...
    def calculate_distance_matrix(self, type):# distance matrix calculation
        ...
        aln = AlignIO.read(open('../Datasets/DNA/n25dna.fas'), 'fasta') #give input fasta alignment file location
